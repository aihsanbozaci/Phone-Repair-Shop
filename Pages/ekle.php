    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Kayıt Ekleme Formu</h1>
          <h2>Buradan alt tabloyu eksiksiz bir şekilde doldurarak telefon kaydı oluşturabilirsiniz.</h2>
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="assets/img/skillss.png" class="img-fluid animated" alt="">  
        </div>
      </div>
...
<form method="POST" action="eklemebaglantisi.php" class="form-horizontal">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="firstname" name="firstname" type="text" placeholder="Ad giriniz" class="form-control input-md" required>
<br>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4" >
  <input id="lastname" name="lastname" type="text" placeholder="Soyad giriniz" class="form-control input-md" required>
  <br>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="tcno" name="tcno" type="number" placeholder="Yalnızca sayı giriniz" class="form-control input-md" required>
  </div>
</div>
<br>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="job" name="job" type="text" placeholder="Model belirtiniz" class="form-control input-md" required>
<br>
  </div>
</div>
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="telno" name="telno" type="number" placeholder="(5xx) xxx xx xx" class="form-control input-md" required>
<br>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="emailid" name="emailid" type="text" placeholder="E-posta giriniz" class="form-control input-md" required>
  <br>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <textarea id="info" name="info" type="text" placeholder="" class="form-control input-md" required></textarea>
  </div>
</div>
<br>
